<!-- Thanks in advance for contributing to this repository! This text will be hidden from your issue and serves as a guide to you when creating an PR.

When suggesting new content for the list, please make sure to add the following details:

 - If you add a entry to the list, ensure your patch does not include any other (formatting) changes outside of that. We do not want every other PR converting the text file from CR/LF to CR and vice versa.
...
The project uses the CC BY-SA 4.0 license, so anything you submit will get the same license when your PR is accepted into the project.

Write your PR note below, after this line! -->
